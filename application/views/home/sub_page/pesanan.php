                ...
                <div class="container">
                    <ul class="nav nav-tabs custom-tabs nav-fill" id="myTab" role="tablist">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link active btn btn-block" id="semua-tab" data-bs-toggle="tab" data-bs-target="#semua"
                        ...
                        <!-- Tab Dikirim -->
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link btn btn-block" id="dikirim-tab" data-bs-toggle="tab" data-bs-target="#dikirim"
                                type="button" role="tab" aria-controls="dikirim" aria-selected="false">Dikirim</button>
                        </li>
                        <!-- Tab Selesai -->
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link btn btn-block" id="selesai-tab" data-bs-toggle="tab" data-bs-target="#selesai"
                                    ...
                                    <div class="row">
                                        <div class="col mt-2">
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-auto">
                                                    <img src="<?= base_url('assets/back-end/img/upload/') . $p['image']; ?>"
                                            ...
                                            <div class="row">
                                                <div class="col mt-2">
                                                    ...
                                                    <div class="row justify-content-center align-items-center mb-3">
                                                        ...
                                                        <div class="col text-end">
                                                            <button class="btn-sm btn-primary me-2">Pesanan Selesai</button>
                                                            <button class="btn-sm btn-secondary">Ajukan Kembalian</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
