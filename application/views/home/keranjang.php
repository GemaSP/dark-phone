        ...
        <div class="row align-items-center">
            <div class="col-5">
                <label class="form-check-label">
                    <input id="checkboxUtama" class="form-check-input me-2" type="checkbox" onclick="checkAll(this)"> Produk
                </label>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-5">
                    <label class="form-check-label d-flex align-items-center">
                        <input class="form-check-input me-2 checkbox-produk" type="checkbox" data-id="<?= $k['id_gadget']; ?>">
                        <img src="<?= base_url('assets/back-end/img/upload/') . $k['image']; ?>" alt="" class="me-2" style="max-width: 50px;">
                        <span><?= $k['nama_gadget'] ?></span>
                    </label>
                </div>
                <div class="col text-center">
                    <span id="harga_<?= $k['id_gadget']; ?>">Rp<?= $harga = number_format($k['harga'], 0, '.', '.'); ?></span>
                </div>
                <div class="col text-center">
                    <div class="input-group d-flex justify-content-center">
                    <input id="nilai_<?= $k['id_gadget'];?>" type="number" class="form-control text-center checkbox-value" value="<?= $k['jumlah_barang']?>" data-id="<?= $k['id_gadget']?>" oninput="updateValue(this.value, this.dataset.id)">
                    </div>
                </div>
                <div class="col text-center">
                    <span id="totalHarga_<?= $k['id_gadget']; ?>">Rp<?php echo number_format($k['harga'] * $k['jumlah_barang'], 0, '.', '.'); ?></span>
                </div>
                <div class="col text-center">
...
<div class="border my-3 p-3 text-white mx-5">
    <div class="container-fluid my-3">
        <div class="row align-items-center">
            <div class="col">
                <label class="form-check-label">
                    <input id="checkboxUtama1" class="form-check-input me-2" type="checkbox" onclick="checkAll(this)"><label for="checkboxUtama1" id="checkboxLabel">Pilih Semua</label></input>
                </label>
            </div>
            ...
            <a href="<?php echo base_url('keranjang/checkout?items='); ?>" id="checkoutButton" class="btn btn-danger">Checkout</a>
            </div>
        </div>
    </div>
</div>
...
function updateCheckoutLink() {
    ...
    var checkoutUrl = "<?= base_url('keranjang/checkout?items='); ?>" + checkedItems.join(',');
